...
class LoyaltyProgramFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'type' => $type,
            'points_per_currency' => $this->faker->randomFloat(2, 1, 20),
            'currency_per_point' => $this->faker->randomFloat(2, 0.01, 0.1),
            'min_points_redemption' => $this->faker->numberBetween(50, 200),
            'points_expiry_months' => $this->faker->optional()->numberBetween(6, 24),
