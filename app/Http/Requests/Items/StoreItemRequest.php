...
class StoreItemRequest extends FormRequest
{
    ...
    {
        // Only vendors and employees can create items
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            // Validate stock management fields
            if ($this->stock_management == 1) {
                if (!$this->has('qty')) {
                    $validator->errors()->add('qty', 'Quantity is required when stock management is enabled');
                }
            }
        });
    }
