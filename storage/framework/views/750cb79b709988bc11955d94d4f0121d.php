                ...
                <div class="card-body">
                    <div class="dashboard-card">
                        <span class="<?php echo e(session()->get('direction') == 2 ? 'text-end' : 'text-start'); ?>">
                            ...
                            <h4 class="text-dark fw-bold fs-2"><?php echo e(helper::currency_formate($totalrevenue, $vendor_id)); ?></h4>
                        </span>
                        <span class="card-icon">
...
<?php /**PATH /Users/teya2023/Documents/codecayon SaaS/restrosaas-37/saas-whatsapp/restro-saas/resources/views/admin/orders/statistics.blade.php ENDPATH**/ ?>