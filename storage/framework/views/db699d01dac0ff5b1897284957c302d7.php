<nav aria-label="breadcrumb">
  ...
  <?php if(request()->is('admin/employees')): ?>
    ...
    <?php if(request()->is('admin/store_categories/add*') || request()->is('admin/store_categories/edit-*')): ?>
        ...
        <li class="breadcrumb-item active <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>"
            aria-current="page"><a href="<?php echo e(URL::to('admin/store_categories')); ?>"><?php echo e(trans('labels.store_categories')); ?></a></li>
...
<?php endif; ?>
        ...
        <?php if(request()->is('admin/roles/add*') || request()->is('admin/roles/edit-*')): ?>
            ...
            <li class="breadcrumb-item active <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>"
                aria-current="page"><a
                    href="<?php echo e(URL::to('admin/roles')); ?>"><?php echo e(trans('labels.roles')); ?></a></li>
...
<?php /**PATH /Users/teya2023/Documents/codecayon SaaS/restrosaas-37/saas-whatsapp/restro-saas/resources/views/admin/layout/breadcrumb.blade.php ENDPATH**/ ?>