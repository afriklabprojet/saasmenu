...
return [
    ...
    */
    ...
    'channels' => [
        ...
        // Canal spécifique pour les événements de sécurité
        'security' => [
            'driver' => 'daily',
        ...
        // Canal pour les métriques de performance
        'performance' => [
            'driver' => 'daily',
        ...
        // Canal pour les erreurs de paiement
        'payments' => [
            'driver' => 'daily',
        ...
        // Canal pour la formation équipe admin
        'training' => [
            'driver' => 'daily',
            'path' => storage_path('logs/training.log'),
            'level' => 'info',
            'days' => 365, // Conserver 1 an pour suivi formations
            'tap' => [App\Logging\TrainingLogFormatter::class],
        ],
        ...
        'notifications' => [
            ...
            'level' => 'info',
            'days' => 90, // Historique notifications 3 mois
            'tap' => [App\Logging\NotificationLogFormatter::class],
        ],
