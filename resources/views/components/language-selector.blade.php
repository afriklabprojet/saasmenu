        ...
        <ul class="dropdown-menu" aria-labelledby="languageDropdown">
            <li>
                <a class="dropdown-item {{ app()->getLocale() == 'en' ? 'active' : '' }}" href="{{ route('lang.switch', 'en') }}">
                    <img src="{{ asset('flags/en.png') }}" alt="English" width="16" height="12" class="me-2"> English
                </a>
            </li>
            <li>
                <a class="dropdown-item {{ app()->getLocale() == 'fr' ? 'active' : '' }}" href="{{ route('lang.switch', 'fr') }}">
                    <img src="{{ asset('flags/fr.png') }}" alt="Français" width="16" height="12" class="me-2"> Français
                </a>
            </li>
            <li>
                <a class="dropdown-item {{ app()->getLocale() == 'ar' ? 'active' : '' }}" href="{{ route('lang.switch', 'ar') }}">
                    <img src="{{ asset('flags/ar.png') }}" alt="العربية" width="16" height="12" class="me-2"> العربية
                </a>
            </li>
        </ul>
    </div>
