                    ...
                    <form action="{{ URL::to('admin/plan/update_plan-' . $editplan->id) }}" method="POST">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group ">
                                ...
                                {{-- Limite Produits --}}
                                <div class="form-group">
                                    <label class="form-label mt-2">{{ trans('labels.products') }} {{ trans('labels.limit') }}</label>
                                    <select class="form-select products_limit_type" name="products_limit_type">
                                        <option value="1" {{ $editplan->products_limit != '-1' ? 'selected' : '' }}>
                                            {{ trans('labels.limited') }}
                                        </option>
                                        <option value="2" {{ $editplan->products_limit == '-1' ? 'selected' : '' }}>
                                            {{ trans('labels.unlimited') }}
                                        </option>
                                    </select>
                                    @error('products_limit_type')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group 1 products-limit">
                                    <input type="number" class="form-control numbers_only" name="plan_products_limit"
                                        value="{{ $editplan->products_limit == -1 ? '' : $editplan->products_limit }}"
                                        placeholder="{{ trans('labels.products') }} {{ trans('labels.limit') }}">
                                    @error('plan_products_limit')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                {{-- Limite Catégories --}}
                                <div class="form-group">
                                    <label class="form-label mt-2">{{ trans('labels.categories') }} {{ trans('labels.limit') }}</label>
                                    <select class="form-select categories_limit_type" name="categories_limit_type">
                                        <option value="1" {{ $editplan->categories_limit != '-1' ? 'selected' : '' }}>
                                            {{ trans('labels.limited') }}
                                        </option>
                                        <option value="2" {{ $editplan->categories_limit == '-1' ? 'selected' : '' }}>
                                            {{ trans('labels.unlimited') }}
                                        </option>
                                    </select>
                                    @error('categories_limit_type')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group 1 categories-limit">
                                    <input type="number" class="form-control numbers_only" name="plan_categories_limit"
                                        value="{{ $editplan->categories_limit == -1 ? '' : $editplan->categories_limit }}"
                                        placeholder="{{ trans('labels.categories') }} {{ trans('labels.limit') }}">
                                    @error('plan_categories_limit')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                {{-- Limite Staff --}}
                                <div class="form-group">
                                    <label class="form-label mt-2">{{ trans('labels.employees') }} {{ trans('labels.limit') }}</label>
                                    <select class="form-select staff_limit_type" name="staff_limit_type">
                                        <option value="1" {{ $editplan->staff_limit != '-1' ? 'selected' : '' }}>
                                            {{ trans('labels.limited') }}
                                        </option>
                                        <option value="2" {{ $editplan->staff_limit == '-1' ? 'selected' : '' }}>
                                            {{ trans('labels.unlimited') }}
                                        </option>
                                    </select>
                                    @error('staff_limit_type')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group 1 staff-limit">
                                    <input type="number" class="form-control numbers_only" name="plan_staff_limit"
                                        value="{{ $editplan->staff_limit == -1 ? '' : $editplan->staff_limit }}"
                                        placeholder="{{ trans('labels.employees') }} {{ trans('labels.limit') }}">
                                    @error('plan_staff_limit')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 mt-2">
                            <div class="form-group">
                                <input class="form-check-input" type="checkbox" name="whatsapp_integration"
                                    @if ($editplan->whatsapp_integration == '1') checked @endif id="whatsapp_integration">
                                <label class="form-check-label"
                                    for="whatsapp_integration">{{ trans('labels.whatsapp_integration') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mt-2">
                            <div class="form-group">
                                <input class="form-check-input" type="checkbox" name="analytics"
                                    @if ($editplan->analytics == '1') checked @endif id="analytics">
                                <label class="form-check-label"
                                    for="analytics">{{ trans('labels.analytics') }}</label>
                            </div>
                        </div>
                            </div>
                            <div class="col-md-12">
