                                    ...
                                    <form class="my-3" method="POST" action="{{ URL::to('admin/register_vendor') }}">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <label for="store_name" class="form-label">Nom du Restaurant/Commerce<span class="text-danger"> * </span></label>
                                                <input type="text" class="form-control" name="store" value="{{ old('store') }}" id="store_name" placeholder="Ex: Restaurant Le Bon Goût" required>
                                                @error('store')
