...
@endphp
@section('styles')
    <link rel="stylesheet" href="{{ url('storage/admin-assets/css/timepicker/jquery.timepicker.min.css') }}">
@endsection
@section('content')
...
@endsection
@section('scripts')
    <script src="{{ url('storage/admin-assets/js/timepicker/jquery.timepicker.min.js') }}"></script>
