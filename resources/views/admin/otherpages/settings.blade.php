                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 selectimg">
                                            <div class="form-group">
                                                ...
                                                <span class="badge badge bg-danger ms-2">{{ trans('labels.addon') }}</span>
                                                @endif
                                                <p class="small text-muted mb-3">Choisissez comment afficher vos produits sur votre boutique en ligne</p>
                                                <div class="row">
                                                    <div class="col-12 col-md-6 mb-3">
                                                        <label for="template_type_1" class="radio-card position-relative cursor-pointer">
                                                            ...
                                                            <div class="card-content-wrapper border rounded-2">
                                                                ...
                                                                <div class="selecimg">
                                                                    <img src="{{ helper::image_path('theme-grid.png') }}" class="w-100 h-100 rounded-2">
                                                                </div>
                                                                <div class="p-3 text-center border-top">
                                                                    <h6 class="mb-1 fw-bold">Affichage en grille</h6>
                                                                    <small class="text-muted">Vue en cartes (recommandé)</small>
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <div class="col-12 col-md-6 mb-3">
                                                        <label for="template_type_2" class="radio-card position-relative cursor-pointer">
                                                            <input type="radio" name="template_type" id="template_type_2" value="2" {{ @$settingdata->template_type == 2 ? 'checked' : '' }}>
                                                            <div class="card-content-wrapper border rounded-2">
                                                                <span class="check-icon position-absolute m-2"></span>
                                                                <div class="selecimg">
                                                                    <img src="{{ helper::image_path('theme-list.png') }}" class="w-100 h-100 rounded-2">
                                                                </div>
                                                                <div class="p-3 text-center border-top">
                                                                    <h6 class="mb-1 fw-bold">Affichage en liste</h6>
                                                                    <small class="text-muted">Vue détaillée avec description</small>
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
...
<style>
    ...
    .radio-card:hover .card-content-wrapper {
    ...
    .radio-card input[type="radio"]:checked ~ .card-content-wrapper .check-icon::after {
        content: "✓";
        color: white;
        font-size: 14px;
        font-weight: bold;
...
<script src="{{ url('storage/admin-assets/js/user.js') }}"></script>
@if ($vendor_id == 1)
