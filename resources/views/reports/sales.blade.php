...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-item">
                ...
                <div class="summary-value">${{ number_format($summary['total_delivery'], 2) }}</div>
            </div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>${{ number_format($order->total - $order->tax - $order->delivery_fee, 2) }}</td>
    ...
    <div class="footer">
        Generated on {{ now()->format('d M Y H:i:s') }} | RestroSaaS Sales Report
    </div>
</body>
</html>
