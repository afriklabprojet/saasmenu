...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-item">
                ...
                <div class="summary-value">{{ $summary['active_customers'] }}</div>
            </div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="badge {{ $customer->orders_count > 0 ? 'badge-active' : 'badge-inactive' }}">
    ...
    <div class="footer">
        Generated on {{ now()->format('d M Y H:i:s') }} | RestroSaaS Customers Report
    </div>
</body>
</html>
