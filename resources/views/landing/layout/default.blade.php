...
<head>
    ...
    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/css/all.min.css')}}">

    <!-- owl carousel css -->

    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/css/owl.carousel.min.css')}}">

    <!-- owl carousel css -->

    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/css/owl.theme.default.min.css')}}">

    <!-- Poppins fonts -->

    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/fonts/poppins.css')}}">

    <!-- bootstrap-icons css -->

    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/css/bootstrap-icons.css')}}">

    <!-- bootstrap css -->

    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/css/bootstrap.min.css')}}">

    <!-- style css -->

    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/css/style.css')}}">

    <!-- responsive css -->

    <link rel="stylesheet" href="{{asset(env('ASSETSPATHURL').'landing/css/responsive.css')}}">
    <style>
        :root {
...
<body>
    ...
    <script src="{{asset(env('ASSETSPATHURL').'landing/js/jquery.min.js')}}"></script>

    <!-- Bootstrap js -->

    <script src="{{asset(env('ASSETSPATHURL').'landing/js/bootstrap.bundle.min.js')}}"></script>

    <!-- owl carousel js -->

    <script src="{{asset(env('ASSETSPATHURL').'landing/js/owl.carousel.min.js')}}"></script>

    <!-- custom js -->

    <script src="{{asset(env('ASSETSPATHURL').'landing/js/custom.js')}}"></script>
